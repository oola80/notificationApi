...
describe('HttpExceptionFilter', () => {
  ...
  it('should transform class-validator error array to EIS-001', () => {
    const body = {
      statusCode: 400,
      message: ['sourceId should not be empty', 'name should not be empty'],
      error: 'Bad Request',
    };
  ...
  it('should wrap string response with EIS-007', () => {
