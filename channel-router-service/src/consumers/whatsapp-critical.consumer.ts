...
@Injectable()
export class WhatsappCriticalConsumer extends BaseDeliveryConsumer {
  protected readonly logger = new Logger(WhatsappCriticalConsumer.name);
  protected readonly channel = 'whatsapp';
  protected readonly priority = 'critical';
  protected readonly queueName = QUEUE_DELIVER_WHATSAPP_CRITICAL;
  ...
  @RabbitSubscribe({
    ...
    routingKey: 'notification.deliver.critical.whatsapp',
    queue: QUEUE_DELIVER_WHATSAPP_CRITICAL,
    queueOptions: {
      durable: true,
