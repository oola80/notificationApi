...
@Injectable()
export class SmsCriticalConsumer extends BaseDeliveryConsumer {
  protected readonly logger = new Logger(SmsCriticalConsumer.name);
  protected readonly channel = 'sms';
  protected readonly priority = 'critical';
  protected readonly queueName = QUEUE_DELIVER_SMS_CRITICAL;
  ...
  @RabbitSubscribe({
    ...
    routingKey: 'notification.deliver.critical.sms',
    queue: QUEUE_DELIVER_SMS_CRITICAL,
    queueOptions: {
      durable: true,
